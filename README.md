...
3. **Limit your friend requests**
   <p align="center">
     <img width="731" height="217" alt="image" src="https://github.com/user-attachments/assets/1bc18dc4-87be-488f-bcab-30d7e28e3543" />
   </p>
...
<p align="center">
  <img width="451" height="563" alt="image" src="https://github.com/user-attachments/assets/87bec196-ab34-43df-8f0f-e26bdd8959e0" />
</p>
...
This user is a clearly compromised account. They have discord nitro but this does not matter here, do not trust just because somebody has nitro that they are legitmate. They also had no activity in the server, and randomly sent me a dm out of all people. They were not a moderator nor had a reason to reach out to me, which 9/10 is what scammers do by targeting people with discord nitro (like I do, sue me I like using cute emojis) or accounts that seem valuable. 
...
<summary>List of scams I have personally been sent</summary>
I have seen the following used as scams in my time:

*   **Starving artist looking for work**
    <p align="center">
      <img width="1156" height="691" alt="image" src="https://github.com/user-attachments/assets/46cc7498-9325-4ca1-84e7-37fec8a911bc" />
    </p>
...
<details>
<summary>Inside is a flow chart that is very easy to break down and understand with the information that's been given so far.</summary>
   
```mermaid
flowchart TD
    Start(["Incoming DM"]) --> Known{"Do you know<br/>this person?"}
    
    Known -->|Yes| Safe["Likely Safe"]
    Known -->|No| Context{"Do you share<br/>a server/interest?"}
    
    Context -->|No| RedFlag1["High Suspicion<br/>(Random DM)"]
    Context -->|Yes| Analyze["Analyze Content"]
    RedFlag1 --> Analyze
    
    Analyze --> Selling{"Are they<br/>selling/begging?"}
    
    Selling -->|Yes| Scammer["<b>LIKELY SCAMMER</b>"]
    Selling -->|No| Payload{"Links or Files?"}
    
    Payload -->|Yes| Scammer
    Payload -->|No| Pressure{"Are they<br/>pressuring you?"}
    
    Pressure -->|Yes| Scammer
    Pressure -->|No| Caution["Proceed with Caution"]
    
    Scammer --> Action["<b>BLOCK & REPORT</b>"]
    
    %% Coloring for readability
    style Start fill:#f9f,stroke:#333,stroke-width:2px
    style Scammer fill:#ff9999,stroke:#f00,stroke-width:2px
    style Action fill:#cc0000,stroke:#333,stroke-width:2px,color:#fff
    style Safe fill:#ccffcc,stroke:#333,stroke-width:2px
    style Caution fill:#ffffcc,stroke:#333,stroke-width:2px
```
</details>
